...
import { TimeSinceLastRepAlert } from '../components/time-since-last-rep-alert';
  ...
  return (
    <Layout title="Home" onChangePage={onChangePage}>
      <Box display="flex" flexDirection="column" rowGap="space70" flexGrow={1}>
        ...
        <TimeSinceLastRepAlert lastRep={eventsData.last_rep} />
          ...
          >
            <Box paddingX="space40" paddingTop="space40">
              ...
              {eventsData.events.map((event) => (
                <EventRow key={event.start_utc} event={event} />
              ))}
            </Box>
